export const queryKeys = {
  ...
  paginatedRepositories: (params: {
    search?: string;
    filter?: string;
    limit?: number;
    cursor?: number | null;
  }) => ['repositories', 'paginated', params] as const,
  searchedRepositories: (params: {
    query: string;
    filter?: string;
    limit?: number;
    cursor?: number | null;
  }) => ['repositories', 'search', params] as const,
  search: (query: string, limit: number, offset: number) =>
    ['search', query, limit, offset] as const,
  starredRepositories: (limit: number, offset: number) =>
    ['repositories', 'starred', limit, offset] as const,
  recentRepositories: (limit: number, offset: number) =>
    ['repositories', 'recent', limit, offset] as const,
  ...
  repositoryFilesByPath: (repoId: number, filePath: string) =>
    ['repository', repoId, 'files', filePath] as const,
  repositoryFilesByExtension: (repoId: number, extension: string) =>
    ['repository', repoId, 'files', extension] as const,
  repositoryFileStats: (repoId: number) => ['repository', repoId, 'file-stats'] as const,
  repositoryFileStatsByPath: (repoId: number, filePath: string) =>
    ['repository', repoId, 'file-stats', filePath] as const,
  ...
  commits: (repoId: number, limit: number, offset: number) =>
    ['repository', repoId, 'commits', limit, offset] as const,
  commitsGraph: (repoId: number, limit: number, offset: number) =>
    ['repository', repoId, 'commits-graph', limit, offset] as const,
  commit: (repoId: number, commitHash: string) =>
    ['repository', repoId, 'commit', commitHash] as const,
  commitDiff: (repoId: number, commitHash: string) =>
    ['repository', repoId, 'commit', commitHash, 'diff'] as const,
  commitDiffInline: (repoId: number, commitHash: string) =>
    ['repository', repoId, 'commit', commitHash, 'diff-inline'] as const,
  branches: (repoId: number) => ['repository', repoId, 'branches'] as const,
  branch: (repoId: number, branchName: string) =>
    ['repository', repoId, 'branch', branchName] as const,
